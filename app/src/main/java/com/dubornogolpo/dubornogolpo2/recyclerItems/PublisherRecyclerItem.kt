...
class PublisherRecyclerItem (val publisherImage: ItemImage) : Item<GroupieViewHolder>()
{
    ...
    override fun bind(viewHolder: GroupieViewHolder, position: Int) {
        Picasso.get().load(publisherImage.url).fit().into(viewHolder.itemView.storyImage)
    }
