...
class EditorialRecyclerItem (val editorialImage: ItemImage) : Item<GroupieViewHolder>()
{
    ...
    override fun bind(viewHolder: GroupieViewHolder, position: Int) {
        Picasso.get().load(editorialImage.url).fit().into(viewHolder.itemView.storyImage)
    }
